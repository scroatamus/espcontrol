...
async def to_code(config: ConfigType) -> None:
    ...
    if data.player_support:
        ...
        # This device's playback path is mono; advertising stereo causes stream
        # negotiation to prefer 2ch and can leave the sink in a format mismatch loop.
        audio_format_structs = [
            _audio_format(codec, channels) for codec in codecs for channels in (1,)
        ]
