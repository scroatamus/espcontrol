...
description:
  EspControl on the ESP32-P4 86 - a 4-inch 720x720 square touchscreen with 9 cards, powered by ESP32-P4.
---

# 4-inch ESP32-P4 86

The **ESP32-P4 86** is a 4-inch square touchscreen powered by an **ESP32-P4** processor. It uses the same 3x3 EspControl layout as the Guition 4848S040, but with a sharper 720x720 display and a faster P4 platform.
